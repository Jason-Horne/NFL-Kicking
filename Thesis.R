...
y_pred_prob <- predict(model2, type = "response", newdata = merged_df1)
...
#Missed Kicks
missed_kicks_2019 <- kicks_2019[!is.na(kicks_2019$Miss_Direction),]
missed_kicks_2020 <- kicks_2020[!is.na(kicks_2020$Miss_Direction),]

missed_kicks <- rbind(missed_kicks_2019, missed_kicks_2020)
